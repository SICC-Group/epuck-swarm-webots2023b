...
class WebotsDifferentialDriveNode(WebotsNode):
    ...
    def __init__(self,
        ...
        # Parametrise
        angle_param = self.declare_parameter('angle', angle)
        position_param = self.declare_parameter('position', position)
        ...
        self.position = position_param.value
        self.angle = angle_param.value
