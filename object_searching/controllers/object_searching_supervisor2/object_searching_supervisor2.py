...
def init():
    ...
    try:
        for i in range(N):
            ...
            importRobot(i,xz[j][1],xz[j][0],y_[j],rolist[j],rgblist[j])
        s.connect((IP,PORT))
        msg='ready'
        msg=msg.encode()
        s.send(msg)
...
def drawtiles(black_list, object_list, use_flat):
    ...
    if use_flat:
        tiles_list = ["""
                                        ...
                                        """ % (-1.55+0.1*(j+1),-1.55+0.1*(i+1),0.2,0.2,0.2) if 30*i+j in black_list else 
                                        """
                                        Solid {
                                            translation %f %f 0.001
                                            rotation 1 0 0 1.57
                                        ...
                                        """ % (-1.55+0.1*(j+1),-1.55+0.1*(i+1),1,1,1) for i in range(30) for j in range(30)]
    else:
        tiles_list = ["""
                                        Solid {
                                            translation %f %f 0.001
                                        ...
                                        """ % (-1.55+0.1*(j+1),-1.55+0.1*(i+1),0,1,1) if 30*i+j in black_list else 
                                        """
                                        Solid {
                                            translation %f %f 0.001
                                            rotation 1 0 0 1.57
                                        ...
                                        """ % (-1.55+0.1*(j+1),-1.55+0.1*(i+1)) if 30*i+j in object_list else
                                        """
                                        Solid {
                                            translation %f %f 0.001
                                            rotation 1 0 0 1.57
