...
parser.add_argument("--byz_num", type=int, default=2,
...
parser.add_argument('--env_name', type=str, default="bandw_estimation")
parser.add_argument('--algorithm_name', type=str, default="A3C")
parser.add_argument('--experiment_name', type=str, default="check")
###############################################################################
parser.add_argument('--max_steps', type=int, default=100,  #2000000
                    help="Number of env steps to train for")
parser.add_argument('--episode_length', type=int, default=20, #300
                    help="Max length for any episode")

# parser.add_argument('--t_max', type=int, default=2000000)
# parser.add_argument('--buffer_length', type=int, default=256)
###############################################################################
...
parser.add_argument('--eval_interval', type=int,  default=1,  # 2000
